...
import { serializerCompiler } from './schema-compilers.js';
import ValidatorSelector from '@fastify/ajv-compiler';
...
class SchemaController {
  ...
  setupValidator(serverOption) {
    ...
    this.validatorCompiler = this.compilersFactory.buildValidator(
  ...
  setupSerializer(serverOption) {
    ...
    this.serializerCompiler = this.compilersFactory.buildSerializer(
      this.schemaBucket.getSchemas(),
