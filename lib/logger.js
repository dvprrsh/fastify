 ...
 */
import nullLogger from "abstract_logging";
import pino, { symbols, destination, stdSerializers } from "pino";
const { serializersSym } = symbols;
import { FST_ERR_LOG_INVALID_DESTINATION } from "./errors.js";
