...
let validate = (function () {
  ...
  return function validate(
    ...
    if (data && typeof data === "object" && !Array.isArray(data)) {
      ...
      if (valid1) {
        let data1 = data.connectionTimeout;
        let errs_1 = errors;
            ...
            if (valid1) {
              ...
              if (valid1) {
                ...
                if (valid1) {
                    ...
                    if (valid4 && prevValid3) {
                      ...
                      if (
                        ...
                        if (true) {
                          let errs__4 = errors;
                          let valid5 = true;
                          for (let key4 in data1) {
                            let isAdditional4 = !(
                              false || key4 == "allowHTTP1"
                            );
                            if (isAdditional4) {
                              delete data1[key4];
                            }
                        ...
                        validate.errors = [
                          {
                            ...
                            schemaPath:
                              "#/properties/https/then/setDefaultValue",
                            params: {
                              keyword: "setDefaultValue",
                            },
                            message:
                              'should pass "setDefaultValue" keyword validation',
                          },
                        ];
                        return false;
                      } else {
                  ...
                  if (valid1) {
                    let data1 = data.ignoreTrailingSlash;
                    let errs_1 = errors;
                    if (typeof data1 !== "boolean") {
                      let dataType1 = typeof data1;
                      let coerced1 = undefined;
                    ...
                    let valid1 = errors === errs_1;
                    if (valid1) {
                      let data1 = data.disableRequestLogging;
                      let errs_1 = errors;
                      if (typeof data1 !== "boolean") {
                        let dataType1 = typeof data1;
                        let coerced1 = undefined;
                          ...
                          validate.errors = [
                            {
                              keyword: "type",
                              dataPath:
                                (dataPath || "") + ".disableRequestLogging",
                              schemaPath:
                      ...
                      if (valid1) {
                        ...
                        let valid1 = errors === errs_1;
                        if (valid1) {
                          let data1 = data.onProtoPoisoning;
                          let errs_1 = errors;
                          ...
                          let valid1 = errors === errs_1;
                          if (valid1) {
                            let data1 = data.onConstructorPoisoning;
                            let errs_1 = errors;
                            if (typeof data1 !== "string") {
                              let dataType1 = typeof data1;
                              let coerced1 = undefined;
                            ...
                            if (valid1) {
                              ...
                              let valid1 = errors === errs_1;
                              if (valid1) {
                                let data1 = data.requestIdHeader;
                                let errs_1 = errors;
                                if (typeof data1 !== "string") {
                                  let dataType1 = typeof data1;
                                  let coerced1 = undefined;
                                    ...
                                    validate.errors = [
                                      {
                                        keyword: "type",
                                        dataPath:
                                          (dataPath || "") + ".requestIdHeader",
                                        schemaPath:
                                          "#/properties/requestIdHeader/type",
                                        params: {
                                          type: "string",
                                        },
                                        message: "should be string",
                                ...
                                let valid1 = errors === errs_1;
                                if (valid1) {
                                  let data1 = data.requestIdLogLabel;
                                  let errs_1 = errors;
                                  if (typeof data1 !== "string") {
                                    let dataType1 = typeof data1;
                                    let coerced1 = undefined;
                                  ...
                                  let valid1 = errors === errs_1;
                                  if (valid1) {
                                    let data1 = data.http2SessionTimeout;
                                    let errs_1 = errors;
                                    if (
                                      typeof data1 !== "number" ||
                                      data1 % 1 ||
                                    ...
                                    if (valid1) {
                                      ...
                                      if (data1 === undefined) {
                                        ...
                                        if (
                                          ...
                                          let missing1;
                                          if (
                                            (data1.storage === undefined &&
                                              (missing1 = ".storage")) ||
                                            (data1.deriveVersion ===
                                              undefined &&
                                              (missing1 = ".deriveVersion"))
                                          ) {
                                            validate.errors = [
                                              {
                                                keyword: "required",
